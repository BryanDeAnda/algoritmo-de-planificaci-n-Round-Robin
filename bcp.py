...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.setStyleSheet("background-color: rgb(176, 207, 255);")
        ...
        self.BCP.setStyleSheet("font: 10pt \"Palatino Linotype\";")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Tabla de procesos (BCP de cada proceso)"))
